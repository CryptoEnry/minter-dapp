const contractAddress = "0x7Ddf24dE9a5E87247866bbe73d164F45b6E71449"; // Replace with your own contract address
const chain = 'goerli'; // goerli, polygon, or ethereum

const welcome_h1 = "Welcome to the Dripping Snakes NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The Dripping Snakes NFT Project is a decentralized, open-source project that aims to demonstrate how to develope and launch your own NFT Collection. target="_blank" rel="noopener noreferrer">codeSTACKr</a> YouTube channel.';
